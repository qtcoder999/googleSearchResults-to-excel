...
var s = driver
  ...
  .then(_ =>
    driver.wait(until.titleIs(process.argv[2] + " - Google Search"), 5000)
  )
  .then(_ => mainInit());
...
function getURLs(URLs) {
  return new Promise(function(resolve, reject) {
    var i = 0;
    driver
      .wait(until.titleIs(process.argv[2] + " - Google Search"), 2000)
      .then(function() {
...
function getTitles(titles) {
  return new Promise(function(resolve, reject) {
    ...
    driver
      ...
      .then(function() {
        driver
          .findElements(By.css(".bkWMgd .g .rc .r > a"))
...
async function navigate1(i) {
  return new Promise(async function(resolve, reject) {
    driver
      ...
      .then(function() {
        driver
          .findElement(By.css('a[aria-label="Page ' + i + '"]'))
          .click()
          .then(async function() {
            await TakeTextsAndURLs();
            resolve();
